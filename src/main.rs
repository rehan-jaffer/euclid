...
fn main() {
    ...
    let cpu = emulator::cpu::CPU { a: 0, b:0, c:0, d:0, e:0, h:0, l:0, clock_m: 0, clock_t: 0, f: 0, sp: 0, pc: 0, m: 0,  flags: emulator::cpu::Flags { zero: false, negative: false, h: false, c: false } };
